...
class NonStructureFeatures_perBase:
    ...
    def create_feature_vector(self, NonStructureFeaturesIndexes, train=True, majority=True):
            ...
            print('starting building feature vector for chrome_list: {}'.format(chrome_list))
            all_data_index = 0
                ...
                with open(training_file, 'r') as training:
                    ...
                    for sequence in training:
                        ...
                        for word_in_seq_index, word_tag in enumerate(word_tag_list):
                            ...
                            labels = range(0, len(indexes_vector))
                            labels.append('IsGen')
                            indexes_vector.append(current_tag)
...
def main():
    ...
    classifier = Classifier(NonStructureFeatures_perBase_obj)
