...
def main():
    ...
    for chrome in chrome_test_list:
        ...
        write_file_name = datetime.now().strftime\
            ('C:\\Users\\shimo\\Desktop\\STRUCTURED_PREDICTION\\ML_PROJECT\\file_results\\chr' + chrome +
                                                  '_resultNoStop_%d_%m_%Y_%H_%M.csv')
        confusion_file_name = datetime.now().strftime\
            ('C:\\Users\\shimo\\Desktop\\STRUCTURED_PREDICTION\\ML_PROJECT\\confusion_files\\chr' + chrome +
        ...
        seq_labels_file_name = 'C:\\Users\\shimo\\Desktop\\STRUCTURED_PREDICTION\\ML_PROJECT\\sample_labels150\\chr' \
                               + chrome + '_sample_label.xlsx'
